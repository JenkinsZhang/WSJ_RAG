...
from src.agent.tools_daily import create_daily_briefing_tool
...
### 6. daily_briefing — 每日新闻总结
生成一份详细的每日新闻简报，涵盖所有领域，包含头条要闻、各领域详报、跨领域分析和后续展望。
...
- **每日新闻总结**（"今日新闻总结"、"每日简报"、"今天发生了什么"、"昨天的新闻总结"）→ 使用 `daily_briefing`
